...
EXPORT void send_lsl_trigger_display(obs_lsl_t* lslOutput, double sample[]);
EXPORT void send_lsl_trigger_output(obs_lsl_t* lslOutput, double sample[]);
